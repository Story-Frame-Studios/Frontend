...
const ApplicationDetails = () => {
  ...
  const fetchApplicationDetails = async () => {
    ...
    try {
      ...
      if (response.success) {
        console.log(response,"responseeasaaaasase")
  ...
  return (
    ...
    >
      <Descriptions title="Job Information" bordered column={1}>
        <Descriptions.Item label="Job ID">{application.jobId}</Descriptions.Item>
        <Descriptions.Item label="Candidate ID">{application.candidateId}</Descriptions.Item>
      </Descriptions>
